...
| 5 | **MLflow + DVC Experiment Tracking** — version the wine dataset with DVC to S3, track training runs with MLflow, and run the pipeline in GitHub Actions | `302025` | [`mlflow-dvc-tracking`](https://github.com/pulkit-scaler/mlops-assignments/tree/mlflow-dvc-tracking) |
...
git switch mlops-ci-cd        # or: s3-data-wrangler, feature-store, model-registry-canvas, mlflow-dvc-tracking
```
